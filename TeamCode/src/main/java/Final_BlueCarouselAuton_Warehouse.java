    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(bd.getZone() == TOP_LEVEL){
            ...
            Trajectory carousel = drive.trajectoryBuilder(partCarousel.end())
                    .lineToLinearHeading(new Pose2d(3.5,-24),SampleMecanumDrive.getVelocityConstraint(12 , DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                            SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                    .build();
            Trajectory pickDuck = drive.trajectoryBuilder(carousel.end())
                    .lineToLinearHeading(new Pose2d(0,-22, Math.toRadians(10)),SampleMecanumDrive.getVelocityConstraint(5 , DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                            SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
                    .build();
            ...
            Trajectory dropBlock2 = drive.trajectoryBuilder(moreIntake.end())
                    .lineToLinearHeading(new Pose2d(24.5, 8.75, Math.toRadians(40)))
                    .build();
            Trajectory backten = drive.trajectoryBuilder(dropBlock2.end())
                    .lineToLinearHeading(new Pose2d(0, 23, Math.toRadians(-90)))
                    .build();
