...
@Autonomous(name = "Final_RedCarouselAuton_Warehouse", group = "Autonomous")
public class Final_RedCarouselAuton_Warehouse extends LinearOpMode {
    ...
    public static final int MIDDLE_LEVEL_POSITION = 1400;
